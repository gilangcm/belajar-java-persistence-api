...
public class EntityRelationshipTest {
    ...
    void oneToOnePersist() {
        ...
        credential.setId("gils");
        credential.setEmail("gils@example.com");
        credential.setPassword("rahasia");
        entityManager.persist(credential);

        User user = new User();
        user.setId("gils");
        user.setName("Gilang Maulana");
    ...
    void oneToOneFind() {
        ...
        User user = entityManager.find(User.class,"gils");
        Assertions.assertNotNull(user.getCredential());
        Assertions.assertNotNull(user.getWallet());
        Assertions.assertEquals("gils@example.com",user.getCredential().getEmail());
