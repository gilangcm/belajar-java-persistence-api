...
public class InheritanceTest {
    ...
    void singleTableInsert() {
        ...
        manager.setId("diva");
        manager.setName("Diva Cahyani");
        manager.setTotalEmployee(10);
        entityManager.persist(manager);

        VicePresident vp = new VicePresident();
        vp.setId("udin");
        vp.setName("Dinda Naomi");
    ...
    void singleTableFind() {
        ...
        Manager manager = entityManager.find(Manager.class, "diva");
        Assertions.assertEquals("Diva Cahyani", manager.getName());

        Employee employee = entityManager.find(Employee.class,"udin");
        VicePresident vicePresident = (VicePresident) employee;
        Assertions.assertEquals("Dinda Naomi", employee.getName());
